...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="${path }/mypage/myInfo">내정보</a></li>
      ...
      <form name="csDelete" style="text-align: center;" >
        <div style="width: 400px; margin: 0 auto;" >
            <div class="csDelete">
              ...
              <input name="password" type="password" value="유저비밀번호"><br>
              <label for="fname">비밀번호 확인</label>
              <input name="passwordCh" type="password" value="유저비밀번호"><br>
              <label for="fname">연락처</label>
