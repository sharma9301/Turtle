      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col"  style="margin-right: 10px;">
                <a href="${path }/mypage/myInfo"><div class="card" id="mypage1">
                    <div class="card-body">
                        <h4>내 정보</h4>
                        <div>
            ...
            <div class="col" style="margin-right: 10px;">
                <a href="${path }/mypage/delivery"><div class="card" id="mypage2">
                    <div class="card-body">
                        <h4>주문내역</h4>
                        <div>
            ...
            <div class="col" style="margin-right: 10px;">
                <a href="${path }/mypage/reviews"><div class="card" id="mypage3">
                    <div class="card-body">
                        <h4>마이리뷰</h4>
                        <div>
            ...
            <div class="col">
                <a href="${path }/service/fnq"><div class="card" id="mypage4">
                    <div class="card-body">
                        <h4>고객센터</h4>
                        <div>
