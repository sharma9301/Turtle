				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
								role="button" data-toggle="dropdown" aria-haspopup="ture"
								aria-expanded="false">
							demo	
							</a>
					...
					<c:if test="${loginMember==null }">
						...
						<button class="btn btn-outline-success my-2 my-sm-0" 
							type="button" onclick="location.assign('${path}/member/enrollMember.do')">회원가입</button>
					</c:if>
					<c:if test="${loginMember!=null }">
						<span>
						<a href="${path}/member/memberView.do"><c:out value="${loginMember.userName}"/></a> 님, 환영합니다.
						</span>
