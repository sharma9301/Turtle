...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar-->
            <button type="button" class="btn btn-secondary ms-auto me-0 me-md-3 my-2 my-md-0" onclick="location.assign('${path }/logout.do')"><i class="fas fa-sign-out-alt"></i>로그아웃</button>
        </nav>
