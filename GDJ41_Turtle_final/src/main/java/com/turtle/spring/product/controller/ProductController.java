...
//	all
	...
	public ModelAndView productList(ModelAndView mv, HttpServletRequest request,
		...
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/${pageContext.request.contextPath}/product/productList.do?",param ));
...
//	earr,ring,neck,brac
	...
	public ModelAndView productCategoryList(ModelAndView mv, HttpServletRequest request, 
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/${pageContext.request.contextPath}/product/productCategoryList.do?",param));
...
//		안쓰는 title
		...
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/${pageContext.request.contextPath}/product/productDetail.do?pdCode="+pdCode+"&",param));
...
//	sale
	...
	public ModelAndView productSaleList(ModelAndView mv, HttpServletRequest request,
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/${pageContext.request.contextPath}/product/productSaleList.do",param ));
...
//	NEW
	...
	public ModelAndView productNewList(ModelAndView mv, HttpServletRequest request,
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/${pageContext.request.contextPath}/product/productNewList.do",param ));
...
//	BEST
	...
	public ModelAndView productBestList(ModelAndView mv, HttpServletRequest request,
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/${pageContext.request.contextPath}/product/productBestList.do",param ));
