...
//	all
	...
	public ModelAndView productList(ModelAndView mv, HttpServletRequest request,
		...
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/productList.do?",param ));
...
//	earr,ring,neck,brac
	...
	public ModelAndView productCategoryList(ModelAndView mv, HttpServletRequest request, 
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/productCategoryList.do?",param));
...
//		안쓰는 title
		...
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/productDetail.do?pdCode="+pdCode+"&",param));
...
//	sale
	...
	public ModelAndView productSaleList(ModelAndView mv, HttpServletRequest request,
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/productSaleList.do",param ));
...
//	NEW
	...
	public ModelAndView productNewList(ModelAndView mv, HttpServletRequest request,
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/productNewList.do",param ));
...
//	BEST
	...
	public ModelAndView productBestList(ModelAndView mv, HttpServletRequest request,
		...
		param.put("title", title);
		mv.addObject("totalContents",totalData);
		mv.addObject("pageBar",PageFactory.getPageBar(totalData, cPage, numPerpage, 5, "/productBestList.do",param ));
