...
public class ServerConfigure implements WebMvcConfigurer{
	private static final List<String> URL_PATTERNS = Arrays.asList("/member/mypage/*","/admin/*","/product/orderProduct.do","/product/orderCheck.do");  //인터셉터가 동작 해야 될 요청 주소 mapping 목록
